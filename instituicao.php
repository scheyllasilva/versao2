...
<body>
<div class="form">
 <form action="salvarStatus" method="post" style="">
  <section id="container">
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="#" class="logo"><b>REFLORE<span> SE</span></b></a>
      <!--logo end-->
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" style="color:black;" href="#" data-toggle="modal" data-target="#ExemploModalCentralizado1">Adicionar Muda</a></li>
          <li><a class="logout" style="color:black;" href="http://localhost/reflore_se/index.php/principal/sair">Sair</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="http://localhost/reflore_se/assets/img/logooficial.png" class="img-circle" width="80"></a></p>
          <br>
          <?php
            $query = $this->session->get_userdata("usuario logado");
            foreach($query as $row){}
          ?> 
        <h5 class="centered"><?php echo "Nome: ".$row['nome']; ?></h5>
        <br>
        <h5 class="centered"><?php echo "Endereco: ".$row['endereco'];?></h5>
        <br>
        <h5 class="centered"><?php echo "Email: ".$row['email'];?></h5>
        <br>
        <h5 class="centered"><?php echo "<a href='#' data-target='#abriModel' data-toggle='modal'>Editar dados</a>";?></h5> 
        </ul>
        <!-- sidebar menu end-->
      </div>
    </aside>
          ...
          <div class="col-lg-3 ds">
            ...
            <?php
                ...
                foreach($query->result_array("pedido") as $item){
                    echo 
                    "
                    <div class='desc' id='".$item['codigo_usuario']."'>
                        <br id='".$item['codigo_usuario']."'>
                        <div class='thumb' data-toggle='modal'>
                            <span class='badge bg-theme'><i class='fa fa-clock-o'></i></span>
                        </div>
                        <div class='details'>
                            <p>
                            <muted>Contabilizar a quantidade de horas em que o pedido foi feito</muted>
                            <br>
                            <a href='#' data-target='#ExemploModalCentralizado' data-toggle='modal' id='".$item['codigo_usuario']."' class='usuario' style='font-weight: bold !important; color: black;'>".$item['codigo_usuario']." - ".$item['codigo_mudas']."</a>
                            </p>
                        </div>
                    </div>
                    ";
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <div class="modal-footer">
                              <button type="submit" onclick="negar()" id="remover" class="btn btn-danger" data-dismiss="modal">Negar pedido</button>
                              <button type="submit" onclick="aprovar();" id="apagar" class="btn btn-success">Aprovar pedido</button>
                          </div>
                        </form>
                        <div>
                        </div>
...
<div class="modal fade" id="ExemploModalCentralizado1" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="TituloModalCentralizado">Adicionar nova muda</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="form">
          <form action="adicionarmuda" method="post" style="">
            <div class="modal-body">
                ...
                <textarea name="desc_mudas" style="width:100%;"></textarea><br>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="abriModel" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <script src="http://localhost/reflore_se/assets/js/deletar_status.js"></script>
